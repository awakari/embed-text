...
RUN \
    ...
    curl -L https://github.com/microsoft/onnxruntime/releases/download/${ONNX_RUNTIME_VERSION}/onnxruntime-linux-aarch64-${ONNX_RUNTIME_VERSION}.tgz -o /onnxruntime.tgz && \
